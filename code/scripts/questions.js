...
arrow1.forEach((ar,index) => {
    ar.addEventListener("click", ()=>{
        ...
        arrow1.forEach(ar=>{
            ar.src = "../rg/svg/chevron-down.svg";
        });
        ...
        if(flags1[index] == true) {
            flags1[index] = false;
            arrow1[index].src = "../rg/svg/chevron-up.svg";
        }
        else {
            flags1[index] = true;
            arrow1[index].src = "../rg/svg/chevron-down.svg";
        }
    });
});
...
arrow2.forEach((ar,index) => {
    ar.addEventListener("click", ()=>{
        ...
        if(flags2[index] == true) {
            flags2[index] = false;
            arrow2[index].src = "../rg/svg/chevron-up.svg";
        }
        else {
            flags2[index] = true;
            arrow2[index].src = "../rg/svg/chevron-down.svg";
        }
    });
});